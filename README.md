...
- **프로젝트명**: 스마트팜 환경 구축  
- **목표**: 센서와 IoT 기술을 활용하여 작물의 생장 환경을 실시간으로 감지하고  
  자동으로 급수·조명·환기 제어가 가능한 시스템을 구축한다.
...
## **요구사항 정의서**  
> 우리가 만들 시스템이 **무엇을 해야 하는지**를 구체적으로 정리한 문서
